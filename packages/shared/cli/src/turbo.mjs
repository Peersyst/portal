 ...
 * @see https://github.com/vercel/turborepo/issues/1863#issuecomment-1774141219
 */
...
//commandLineArguments.push("--no-update-notifier", "--env-mode=strict", "--framework-inference=false");

if (!commandLineArguments.some((arg) => arg.startsWith("--concurrency"))) {
    commandLineArguments.push("--concurrency=1000");
}
