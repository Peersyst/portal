import { BlueShades, GrayShades, GreenShades, OrangeShades, RedShades, YellowShades } from "@frontend/design-system-core/palette";
import { BasePalette } from "../../common/palette/types";
